    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(children: [
          TextFormField(
                        validator: (val) =>
                            val!.isEmpty ? "Geef de vraag in " : null,
                      ...
                      TextFormField(
                        validator: (val) =>
                            val!.isEmpty ? "Geef optie1" : null,
                        // ignore: prefer_const_constructors
                        decoration: InputDecoration(hintText: "Optie1 (Juiste Antwoord)"),
                        onChanged: (val) {
                          optie1 = val;
                        },
                      ),
